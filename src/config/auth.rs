...
/// Runtime model for embedding API calls.
/// Lightweight — no temperature/thinking/streaming fields that don't apply to embeddings.
#[derive(Clone, Debug)]
pub struct EmbeddingActiveModel {
    pub provider_id: String,
    pub model_id: String,
    pub display_name: String,
    pub base_url: String,
...
/// Display summary of an embedding model (for model panel listing).
#[derive(Clone, Debug)]
