//! Temp file management for tidev.
//!
//! Scans and cleans known tidev temp files from the system temp directory.
//! Used by the `tidev tmp list` and `tidev tmp clean` CLI commands.

use std::path::PathBuf;
use std::time::{Duration, SystemTime};

/// Patterns of files/directories in the system temp dir that tidev is responsible for.
...
pub fn auto_cleanup(config: &tidev_config::TmpConfig) {
...
mod tests {
    ...
    /// Creates a temp file in the system temp dir with a unique name for testing.
