      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-2">
        ...
        <div className="relative">
          ...
          <textarea
            ...
            className={`min-h-[44px] w-full resize-none rounded-xl border px-3 pt-[13px] pb-2.5 text-base text-neutral-900 placeholder-neutral-400 outline-none transition-all duration-150 disabled:opacity-50 dark:text-neutral-100 dark:placeholder-neutral-500 ${
              shellMode
