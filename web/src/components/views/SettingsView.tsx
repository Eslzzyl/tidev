...
export function SettingsView() {
  ...
  return (
    <div className="mx-auto flex h-full w-full max-w-2xl flex-col overflow-y-auto p-4 sm:p-6 lg:max-w-3xl xl:max-w-4xl">
      ...
      <section className="mb-8">
        <h2 className="mb-1 flex items-center gap-2 text-sm font-medium text-neutral-900 dark:text-neutral-100">
          <Lock className="h-4 w-4" /> Web Access
        </h2>
...
function WebAccessSettings() {
  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    const { verifyToken, setToken } = useAuthStore.getState();
        ...
        <form onSubmit={handleChangePassword} className="space-y-3">
          <div>
            ...
            <input
              ...
              className="w-full rounded-md border border-neutral-300 bg-white px-3 py-1.5 text-sm text-neutral-900 placeholder-neutral-400 outline-none focus:border-neutral-500 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100 dark:placeholder-neutral-500"
