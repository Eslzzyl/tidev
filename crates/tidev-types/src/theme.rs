...
//!
//! This type lives in `tidev-types` so that `tidev-engine::config` can
//! serialise it without depending on a UI crate.  The actual colour palettes
//! and rendering live in `tidev-tui`.
