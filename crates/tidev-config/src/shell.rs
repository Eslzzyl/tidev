...
//! auto-detection results).  The bash tool then reads the
...
#[cfg(windows)]
pub fn init(config_shell: Option<String>, paths: Option<&super::ConfigPaths>) {
    RESOLVED.get_or_init(|| resolve(config_shell, paths));
}

#[cfg(not(windows))]
pub fn init(_config_shell: Option<String>, _paths: Option<&super::ConfigPaths>) {
...
#[cfg(windows)]
fn resolve(config_shell: Option<String>, _paths: Option<&super::ConfigPaths>) -> ResolvedShell {
