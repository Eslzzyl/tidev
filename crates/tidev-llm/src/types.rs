...
//!
//! Uses `tidev_types::ApiType` for provider dispatch and `tidev_types::ToolSchema`
//! for the LLM-facing tool interface — both moved here to eliminate the
//! `llm_bridge.rs` conversion layer.
