...
pub use types::LlmProviderConfig;
    ...
    async fn complete_with_retry(
        ...
        for attempt in 1..=MAX_RETRIES {
            let result = match model.api_type {
                ...
                tidev_types::ApiType::OpenAiChatCompletions => {
                ...
                tidev_types::ApiType::OpenAiResponses => {
                ...
                tidev_types::ApiType::GoogleGemini => {
