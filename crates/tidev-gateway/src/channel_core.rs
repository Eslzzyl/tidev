            ...
            "goal" => {
                ...
                match command.args.first().map(|s| s.as_str()) {
                    Some("clear") => {
                        ...
                        sender
                            .send_message(recipient, "Goal cleared.", reply_to)
                            .await?;
                    }
                    Some("pause") => {
                        self.store
                        ...
                        sender
                            .send_message(recipient, "Goal paused.", reply_to)
                            .await?;
                    }
                    Some("resume") => {
                        self.store
                        ...
                        sender
                            .send_message(recipient, "Goal resumed.", reply_to)
                            .await?;
                    }
                    _ => {
                        if command.args.is_empty() {
                            ...
                            sender
                                .send_message(recipient, "Goal set.", reply_to)
                                .await?;
                        }
                    }
                }
