...
use crate::{FileReadTracker, SkillCatalog};
...
pub(super) fn execute_tool_call(
    ...
    let tool_name = crate::canonical_tool_name(&call.name);
    ...
    let mut result = builtin::execute_tool_call(
        &builtin::ToolContext {
            ...
            web_search_config: &tidev_config::WebSearchConfig::default(),
            auth_store: &tidev_config::AuthStore::default(),
            event_tx: None,
        },
        call,
    )?;
