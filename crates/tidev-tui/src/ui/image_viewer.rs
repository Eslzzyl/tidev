...
pub(crate) struct ImageViewerState {
    ...
    /// Image filename for the title bar.
    filename: String,
    /// Image dimensions in pixels.
    width: u32,
    height: u32,
    /// Cached protocol and the area it was created for.
    /// Avoids re-encoding on every frame (resize+encode is expensive).
...
impl ImageViewerState {
    ...
    pub fn render(&mut self, frame: &mut Frame, area: Rect, picker: &Picker) {
        ...
        // Compute centered image area with padding
