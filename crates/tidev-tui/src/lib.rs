...
struct App {
    ...
    /// Kept for UI rendering — actual queueing goes through tidev_agent::SessionManager.
    ...
    pending_permission_rx: Option<
        tokio::sync::mpsc::UnboundedReceiver<tidev_agent::PendingToolApproval>,
    >,
    ...
    pending_permission_response:
        Option<tokio::sync::oneshot::Sender<Vec<tidev_agent::ApprovedTool>>>,
...
impl App {
    ...
    fn build_at_reference_attachment(
        ...
        use tidev_tools::builtin::file::read_file_for_at_reference;
