...
impl App {
    ...
    pub(crate) fn new_with_paths(paths: ConfigPaths) -> Result<Self> {
        ...
        let workspace_root = tidev_engine::tooling::builtin::utils::canonicalize_display(
        ...
        let app = Self {
            ...
            subagent_result_message_map: std::collections::HashMap::new(),
    ...
    pub(crate) fn cache_active_session_runtime(&mut self) {
        ...
        let cached = CachedSessionRuntime {
            ...
            sensitive_file_confirm_dialog: self.sensitive_file_confirm_dialog.clone(),
    ...
    pub(crate) fn restore_cached_session_runtime(&mut self, cached: CachedSessionRuntime) {
        ...
        self.sensitive_file_confirm_dialog = cached.sensitive_file_confirm_dialog;
